...
$pService_Code=$_REQUEST['Service_Code'];
...
$sql="select * from servicemaster where Service_Code='$pService_Code'";
...
while($row=mysql_fetch_array($result))
{
    ...
    $uD1=$row['Service_Code'];
    $uD2=$row['Service_Name'];
    $uD3=$row['Service_Type'];
    $uD4=$row['Service_Charge'];
    
}

?>

<form method="Post" action="ServiceMasterUpdate.php">
